...
const StyleGuideSidebar: React.FC<StyleGuideSidebarProps> = ({ sections, activeSection, onSectionClick }) => {
  return (
    <aside className="w-64 bg-gray-50 dark:bg-gray-800/20 border-r border-gray-200 dark:border-gray-700/50 p-4 shrink-0 overflow-y-auto scrollbar-hide hidden lg:block">
      <div className="flex items-center space-x-3 mb-4 px-2">
        <SlidersIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
